...
public interface IGoogleHttpClient {
	...
	String dispatchPost(URI address, FormBuilder form) throws IOException, URISyntaxException;

	String dispatchPost(URI address, String json) throws IOException, URISyntaxException;
